...
<body>
    <section class="form_box" id="login_box">
        <h1>Inicia sesión</h1>
        <form action="php/login.php" method="POST">
            ...
            <div class="input_box">
                ...
                <input type="password" id="pass_login" maxlength="32" name="pass_login" required>
            </div>
            <button class="btn_submit">Iniciar sesión</button>
        </form>
        <p id="btn_text">¿No tienes cuenta? Toca aquí para registrarte</p>
    </section>
    ...
    <section class="form_box invisible" id="sign_up_box">
        ...
        <form action="php/guardar.php" method="POST"  class="form_sign_up">
            <div class="input_box">
                <label for="name_sign_up">Nombre:</label>
                <input type="text" id="name_sign_up" maxlength="45" name="name" required>
            </div>
            <div class="input_box">
            ...
            <div class="input_box">
                ...
                <input type="password" id="pass_sign_up" maxlength="32" name="pass" required>
            </div>
            <button class="btn_submit">Regístrarse</button>
        </form>
    </section>
